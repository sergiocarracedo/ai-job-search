---
description: Register a custom LaTeX CV or cover letter template with the framework.
---
...
> - **Output file:** unchanged (`data/cv/main_<company>.tex` / `data/cover-letters/cover_<company>_<role>.tex`); copy any class/font files the template needs into the output directory, or reference them by relative path
<!-- END ACTIVE-TEMPLATE -->
```
